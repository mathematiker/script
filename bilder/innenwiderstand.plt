...
f(x,i) = x/(i+x)
GNUTERM = "wxt"
plot f(x,0) title "kein Innenwiderstand", f(x,0.1) title "kleiner Innenwiderstand", f(x,1) title "grosser Innenwiderstand", f(x,5) title "groesserer Innenwiderstand"
#    EOF
